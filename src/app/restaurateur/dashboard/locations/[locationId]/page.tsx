...
export default function EditLocationPage() {
  ...
  const locationId = params.locationId as Id<"restaurantLocations">;

  const myRestaurants = useQuery(api.restaurants.getMyRestaurants);
  const restaurant = myRestaurants?.[0];
  const location = useQuery(
    api.restaurantLocations.getById,
    locationId ? { id: locationId } : "skip"
  );

  // Loading state
  if (myRestaurants === undefined || (locationId && location === undefined)) {
    return (
      ...
      <div className="container mx-auto px-4 py-16">
        <Card className="max-w-md mx-auto">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              This location doesn't exist or you don't have permission to edit it.
            </p>
            <Link href="/restaurateur/dashboard/locations">
  ...
  if (location.restaurantId !== restaurant._id) {
    return (
      <div className="container mx-auto px-4 py-16">
        <Card className="max-w-md mx-auto">
          <CardContent className="p-8 text-center">
  ...
  return <LocationForm restaurantId={restaurant._id} location={location} />;
}
